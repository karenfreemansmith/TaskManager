  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    mTaskList.setOnItemClickListener(new AdapterView.OnItemClickListener(){
      ...
      public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        Toast.makeText(TaskList.this, mTaskDatabase.getDescription(id), Toast.LENGTH_SHORT).show();
      }
    });
    mTaskList.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
      @Override
      public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
        Toast.makeText(TaskList.this, "Records deleted = " + mTaskDatabase.deleteRecord(id), Toast.LENGTH_SHORT).show();
        updateTaskList();
        return true;
      }
    });
